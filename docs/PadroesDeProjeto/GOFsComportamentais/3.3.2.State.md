...
### Execução
Print da execução do código, para rodar basta clicar em run ou digitar python3 "StateFinal.py"
...
|  2.0   | 01/06 | adicionando versão individual da implementação do State |  Maria Eduarda  |   Edilson   | As imagens estavam trocadas, consertado |
