...
![Modelagem do Factory Method - Mídia Digital](../../assets/GOFsCriacionais/FactoryMethod/FactoryMethodfinal.png)

## Interface

<p align="center">
  <img src="../../assets/GOFsCriacionais/FactoryMethod/facthorymethod.gif" alt="GIF" />
</p>
...
[1] Gamma, E., Helm, R., Johnson, R., & Vlissides, J. (1994). Design Patterns: Elements of Reusable Object-Oriented Software. Addison-Wesley.<br>
[2] SERRANO, Milene. AULA - GOFS CRIACIONAIS. Slides. Universidade de Brasília, 2025. Acessado em: 26 de mai. de 2025.
...
| 1.4 | 26/05 | Adicionando versão final do Factory Method | Mateus | - | - |
