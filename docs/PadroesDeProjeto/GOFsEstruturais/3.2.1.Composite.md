...
O Composite organiza objetos em estruturas de árvore (como diretórios e arquivos) onde objetos compostos (composite) podem conter outros objetos (folhas ou outros composites). Assim, você pode tratar um único objeto ou um grupo de objetos da mesma maneira.
...
| `1.3` | 30/05/2025 | Adiciona versão final do Composite | Mateus | - | - |
