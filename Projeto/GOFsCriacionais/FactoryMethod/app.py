...
class CreateMidiaDigital(ABC):
    ...
    @abstractmethod
    def factory_method(self, id: int, legenda: str, url_arquivo: str, resolucao: str = None) -> MidiaDigital:
        pass

    def enviar(self):
        msg = f"Enviando mídia com ID {self.midia.id} e legenda: {self.midia.legenda}"
        return msg

class CreateVideo(CreateMidiaDigital):
    def factory_method(self, id: int, legenda: str, url_arquivo: str, resolucao: str = None) -> MidiaDigital:
        self.midia = Video(id=id, legenda=legenda, url_arquivo=url_arquivo)
        return self.midia

class CreateImagem(CreateMidiaDigital):
    def factory_method(self, id: int, legenda: str, url_arquivo: str, resolucao: str = None) -> MidiaDigital:
        self.midia = Imagem(id=id, legenda=legenda, url_arquivo=url_arquivo, resolucao=resolucao)
        return self.midia
